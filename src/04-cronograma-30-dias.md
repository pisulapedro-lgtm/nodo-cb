...
Día 1 = lunes 03-08-2026 · Día 30 = martes 01-09-2026. Vista Gantt por workstream y detalle día a día con responsable, dependencias y costo (los costos referencian el presupuesto de la sección 5; «—» = sin desembolso propio).
...
## Semana 2 (lun 10-08 → dom 16-08) — La empresa existe y la venta arranca

{{tabla_semana_2}}

## Semana 3 (lun 17-08 → dom 23-08) — Identidad fiscal completa

{{tabla_semana_3}}

## Semana 4 (lun 24-08 → mar 01-09) — Operación plena

{{tabla_semana_4}}

## Lo que sigue después del día 30 (para que nadie se sorprenda)

| Cuándo | Qué | Responsable |
|---|---|---|
| Septiembre | CUIT de Pedro y Sebastián emitidos (camino de 30 días hábiles iniciado en Semana 0) | Gestoría + Ignacio |
