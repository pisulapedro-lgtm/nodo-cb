...
| Rol | Quién | Alcance |
|---|---|---|
| CEO — todos los roles en uno | **Ignacio** (Buenos Aires) | Comercial, administración, contabilidad de gestión, dirección, control de calidad de obras. **No instala.** |
| Instalación | **2 monotributistas subcontratados por obra** | Locación de obra por instalación, con herramientas y vehículo propios |
...
- Contrato de locación de obra **por instalación** (nunca «servicios mensuales»), con precio por obra y derecho del instalador a rechazar obras y hacerse sustituir.
- Factura por obra de montos variables + pago 100% bancarizado (condición del art. 23 LCT).
...
- Póliza AP vigente con no repetición + constancia de monotributo del mes, **antes** de cada obra.
...
| Cierre: obras vendidas / presupuestos | 25-30% | 25-30% |
| Obras terminadas (con checklist firmado) | 4-8 | 18-28 |
| Ticket promedio (equipo + instalación) | $ 1,8-2,5M | $ 2-2,5M |
| Margen bruto por obra | ≥ 30% | ≥ 35% |
