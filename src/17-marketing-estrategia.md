...
|---|---|---|
| **Precio cerrado** | El adicional que aparece a mitad del trabajo | Presupuesto escrito con equipo, materiales, instalación e IVA desglosados. Calculadora pública en la web |
...
| **Posventa real** | El «te llamo mañana» que no llega nunca | Garantía escrita, checklist firmado en el domicilio y WhatsApp que responde en horario |
...
**El cliente es un particular.** Salvo el canal B2B de administraciones y desarrolladores, quien firma es un consumidor final que compra para su casa: paga con tarjeta o transferencia, recibe Factura B y decide en pocos días. Eso ordena todo lo que sigue —el tono, el canal y la velocidad de respuesta— y explica por qué la alerta de la sección 7 sobre la Factura A sujeta a retención afecta poco a este negocio: casi toda la facturación es a consumidor final.

Cuatro segmentos, muy distinto valor y muy distinto costo de captación:

| Segmento | Ticket típico | Cómo llega | Peso en el plan |
|---|---|---|---|
| **Residencial premium** (casa o depto propio, 35-65 años, Núñez a San Isidro) | {{ars:financiero.mix.0.ticket_ars}} – {{ars:financiero.mix.1.ticket_ars}} | Google Search, sobre todo. Busca cuando aprieta el calor | El volumen: 8 de cada 10 instalaciones |
...
| **Administraciones, arquitectos y desarrolladores** | Instalación repetida | LinkedIn, presentación directa, dossier | El canal que estabiliza el invierno |
...
De pesos de pauta a instalaciones cerradas, mes a mes:

{{tabla_embudo}}

Tres lecturas que cambian decisiones:

- **La pauta sola no gana diciembre.** En el pico cubre menos de la mitad del plan. No es un error de presupuesto: es que en diciembre y enero el clic se encarece justo cuando todos lo quieren. **Las {{_mk.instalaciones_propias}} instalaciones que la pauta no paga tienen que venir de canales propios** —posicionamiento en Google, el perfil de empresa, las reseñas y la recomendación—, y esos canales tardan tres meses en madurar. De ahí el plazo que fija la sección 9: top 3 del bloque de mapas **antes del 30 de noviembre**. No es una meta de vanidad; es el 55 % de la facturación del pico.
...
- **El CAC real queda por debajo del que asume el modelo.** {{ars:_mk.cac}} contra los {{ars:financiero.costos_instalacion.cac_ars}} que descuenta el punto de equilibrio de la sección 6. Ese colchón es la tolerancia: hasta {{ars:financiero.costos_instalacion.cac_ars}} por instalación el negocio sigue cerrando como está proyectado.
...
**Google se lleva {{_mk.pct_google}} % del presupuesto medible y produce {{_mk.pct_instalaciones_google}} % de las instalaciones de pauta.** Es la consecuencia de un hecho simple: quien busca «instalación aire acondicionado San Isidro» ya decidió que quiere uno; quien ve un reel todavía no. Meta cuesta menos por lead y bastante más por instalación — sirve para llenar el embudo y construir marca, no para cerrar la temporada.
...
1. **El presupuesto mensual es un techo, no una meta.** Si un mes no se gasta —típico en el valle, donde no hay demanda que comprar—, el remanente se acumula para noviembre y diciembre, que es cuando cada peso rinde más instalaciones.
...
4. **El tope por instalación es {{ars:financiero.costos_instalacion.cac_ars}}.** Por encima de eso la instalación sigue dejando plata, pero se come el colchón con el que está construido el punto de equilibrio.
