...
1. **Respondemos en menos de 5 minutos** en horario comercial.
2. **Visita técnica sin cargo dentro de las 48 horas hábiles** en todo el corredor.
3. **Presupuesto cerrado el mismo día de la visita.**
...
| Situación | Respuesta inmediata | Quién decide |
|---|---|---|
| **El equipo no llega a tiempo** | Avisar **antes** de la fecha comprometida, nunca el mismo día. Ofrecer fecha nueva o equipo equivalente de igual o mayor gama al mismo precio | Ignacio |
| **El instalador no se presenta** | Reagendar en menos de 24 h con la cuadrilla de respaldo y compensar con el mantenimiento del primer año sin cargo | Ignacio |
| **Aparece un adicional durante el trabajo** | Se detiene, se fotografía, se cotiza y se espera aprobación escrita. Si el cliente no acepta, se deja el trabajo en estado seguro y se cobra lo ejecutado | Instalador → Ignacio |
| **Daño en la propiedad del cliente** | Se reconoce en el momento, se fotografía y se repara por cuenta de la empresa o del seguro de responsabilidad civil. **Nunca discutir en el domicilio** | Ignacio |
| **El equipo falla dentro de la garantía** | Visita en menos de 48 h. Si es de instalación, se resuelve sin cargo; si es de fábrica, se gestiona el service oficial y se acompaña el trámite | Ignacio |
| **Reseña negativa** | Respuesta pública en menos de 24 h, sin discutir, ofreciendo resolver por privado. Después, resolver de verdad | Ignacio |
| **Un cliente pide algo que no sabemos hacer** | Se dice que no y se recomienda a alguien. Aceptar un trabajo fuera de competencia es la forma más rápida de conseguir la primera reseña de una estrella | Ignacio |
...
| Indicador | Objetivo | Qué avisa |
|---|---|---|
| **Instalaciones entregadas en la fecha comprometida** | ≥ 95 % | Si baja, se está vendiendo más de lo que se puede ejecutar |
| **Revisitas por defecto propio** | < 5 % | Es el termómetro de la calidad del instalador |
| **Checklists completos con foto** | 100 % | Sin excepciones: es la prueba que sostiene la garantía |
| **Reclamos de garantía en el primer mes** | < 3 % | Un pico acá anticipa un problema sistemático de montaje |
| **Tiempo medio de la instalación tipo** | 4-5 h | Si se alarga, el costo de montaje real supera al presupuestado |
| **Reseñas de 5 estrellas** | ≥ 85 % de las recibidas | La medida final de todo lo anterior |

**Dos reglas de capacidad**, que son las que evitan el desastre de diciembre:

1. **No se agenda a más de tres semanas.** Si la agenda se llena más allá de eso, se baja la pauta (sección 19.4) o se suma cuadrilla — no se estira el plazo.
2. **Ninguna cuadrilla hace más de dos instalaciones por día.** La tercera se hace mal, y una instalación mal hecha en diciembre cuesta la revisita, la reseña y el cliente.
